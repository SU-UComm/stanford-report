...
export default function ContentWithSidebar({
  ...
  const infoBoxData = infoBox.title || infoBox.content || imageData;
  return (
    <Container width="wide">
      <div className="su-grid su-grid-cols-4 sm:su-grid-cols-12 su-grid-gap su-gap-y-0 su-mx-auto lg:su-max-w-none">
        <div
          className={cnb(
            "su-col-span-full sm:su-col-start-2 sm:su-col-span-10 lg:su-col-start-2 lg:su-col-span-7 xl:su-col-start-3 xl:su-col-span-7 xl:last:[&>*]:su-mb-0"
          )}
        >
        ...
        {infoBoxData && (
          <InfoBox
            containerClassName="su-break-words su-col-span-full sm:su-col-start-2 sm:su-col-span-10 lg:su-col-span-4 lg:su-col-start-9 xl:su-col-span-3"
