...
export default function PreferencesTray({ audience, personaClickHandler }) {
  return (
    <div className="su-flex su-items-center su-justify-end su-w-32 md:su-w-[85px] lg:su-w-[91px]">
      <button
        type="button"
        className="su-w-58 su-flex su-flex-wrap su-gap-3 su-justify-center hover:su-text-digital-red dark:hover:su-text-dark-mode-red"
        aria-controls="preferences"
        aria-expanded="false"
        aria-labelledby="toggle-preferences"
      >
        {audience === null || audience === "external" ? (
          <span className="icon-preferences">
            <span className="su-relative su-size-32 su-block su-mx-auto">
              <svg
                aria-hidden="true"
                focusable="false"
        ...
        <div className="report-header__preferences su-overflow-hidden su-h-screen su-bg-white dark:su-bg-black-true su-absolute su-top-0 su-right-0 su-w-full md:su-w-[398px] su-flex su-flex-wrap su-overflow-y-auto su-pb-32 md:su-pb-[64px] su-pt-[115px] md:su-pt-[167px] su-px-38">
          <div className="report-header__preference-content su-transition su-text-black dark:su-text-white">
            <div className="su-gap-27 su-flex su-flex-wrap">
              ...
              <ul className="su-flex su-list-none su-pl-0 su-gap-18 su-w-full">
                <li className="su-mb-0 su-w-1/2">
                  ...
                  <button
                    ...
                    className="report-header__pref-toggle hover:su-text-white su-w-full su-h-full aria-pressed:su-text-white group su-bg-white dark:aria-pressed:su-text-black-true dark:aria-pressed:su-bg-transparent dark:hover:su-bg-transparent aria-pressed:su-bg-transparent hover:su-bg-transparent dark:su-bg-black-true &[aria-pressed=“true”]:dark:su-bg-transparent before:su-rounded-inherit after:su-rounded-inherit before:su-bg-gradient-light-red after:su-transition-none su-transition before:su-transition after:su-bg-gradient-light-red dark:after:su-rotate-180 before:su-absolute before:-su-z-10 before:-su-m-2 after:su-absolute after:-su-z-10 before:su-top-0 before:su-bottom-0 before:su-right-0 before:su-left-0 after:su-top-0 after:su-bottom-0 after:su-right-0 after:su-left-0 su-relative su-bg-transparent su-text-center"
                    data-location="student-info"
                  >
                    <span className="icon-add su-block su-mx-auto su-relative su-w-44 su-h-44 su-text-digital-red dark:su-text-dark-mode-red">
                      <svg
                        className="su-absolute su-top-1/2 su-left-1/2 -su-translate-x-1/2 -su-translate-y-1/2 su-w-44 su-h-44 su-fill-none"
                        xmlns="http://www.w3.org/2000/svg"
                        width="44"
                        height="44"
                        viewBox="0 0 44 44"
                    ...
                    <span className="icon-remove su-block su-mx-auto su-relative su-w-44 su-h-44">
                      <svg
                        className="su-absolute su-top-1/2 su-left-1/2 -su-translate-x-1/2 -su-translate-y-1/2 su-w-44 su-h-44 su-fill-none"
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
                    ...
                    <span className="icon-detail su-block su-mb-6 su-mt-18 su-mx-auto su-relative su-w-[1.838rem] su-h-21">
                      <svg
                        className="su-absolute su-top-1/2 su-left-1/2 -su-translate-x-1/2 -su-translate-y-1/2"
                        xmlns="http://www.w3.org/2000/svg"
                        width="20"
                    ...
                    <span className="su-block su-text-18 su-leading-[2.25rem] su-w-full">
                      Student information
                    </span>
                  </button>
                </li>
              ...
              <div className="su-flex su-flex-wrap su-gap-9">
                <p className="su-mb-0 su-text-16 su-font-normal su-leading-[2rem]">
                  ...
                  using “Clear all personalization” below.
                </p>
                <button
                  type="button"
                  id="preference-reset"
            ...
            <form className="su-gap-27 su-flex su-flex-wrap su-pt-38 su-cursor-pointer">
              ...
              >
                ...
                >
                  ...
                  <span
                    aria-hidden="true"
                    className="su-inline-block su-align-middle su-relative su-w-28 su-h-28 peer-checked/light:su-hidden"
                  >
                    <svg
                      className="su-absolute su-top-1/2 su-left-1/2 -su-translate-x-1/2 -su-translate-y-1/2"
                      xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span
                    aria-hidden="true"
                    className="su-hidden su-align-middle su-relative su-w-28 su-h-28 peer-checked/light:su-inline-block"
                  >
                    <svg
                      className="su-fill-transparent"
                      xmlns="http://www.w3.org/2000/svg"
                      width="28"
                      height="28"
                      viewBox="0 0 28 28"
                    ...
                    >
                      <path
                        d="M14 3.5V4.66667M14 23.3333V24.5M24.5 14H23.3333M4.66667 14H3.5M21.4246 21.4246L20.5997 20.5997M7.40034 7.40034L6.57538 6.57538M21.4247 6.57544L20.5997 7.4004M7.4004 20.5997L6.57544 21.4247M18.6667 14C18.6667 16.5773 16.5773 18.6667 14 18.6667C11.4227 18.6667 9.33333 16.5773 9.33333 14C9.33333 11.4227 11.4227 9.33333 14 9.33333C16.5773 9.33333 18.6667 11.4227 18.6667 14Z"
                        stroke="#767674"
                        strokeWidth="2"
                        strokeLinecap="round"
                        strokeLinejoin="round"
                ...
                >
                  <span
                    aria-hidden="true"
                    className="su-inline-block su-align-middle su-relative su-w-28 su-h-28"
                    data-role="su-darkmode-icon-nonactive"
                  >
                    <svg
                  ...
                  <span
                    className="su-hidden su-inline-block su-align-middle su-relative su-w-28 su-h-28"
                    data-role="su-darkmode-icon-active"
                  >
                    <svg
                      width="24"
                      height="24"
                    ...
                    >
                      <path
                        d="M20.7515 15.9516C19.5464 16.4965 18.2086 16.7999 16.8 16.7999C11.4981 16.7999 7.20002 12.5019 7.20002 7.19992C7.20002 5.79116 7.50347 4.45327 8.04857 3.24805C4.71767 4.75435 2.40002 8.10636 2.40002 11.9997C2.40002 17.3016 6.69809 21.5997 12 21.5997C15.8932 21.5997 19.2451 19.2822 20.7515 15.9516Z"
                        fill="url(#paint0_linear_3034_2174)"
                      />
                      <defs>
                        <linearGradient
                          id="paint0_linear_3034_2174"
                          x1="2.40002"
                          y1="3.24805"
                          x2="20.7515"
                          y2="3.24805"
                          gradientUnits="userSpaceOnUse"
                        >
                          <stop stopColor="#279989" />
                          <stop offset="1" stopColor="#8F993E" />
                        </linearGradient>
                      </defs>
                    </svg>
                  </span>
                  <span className="su-inline-block su-align-middle su-text-18 su-leading-[2.25rem]">
                    Dark
                  </span>
                </label>
              </fieldset>
          ...
          <button
            type="button"
            className="report-header__preferences-close su-absolute su-right-38 su-top-43 md:su-top-72 su-w-32 su-flex su-flex-wrap su-gap-3 su-justify-center dark:hover:su-text-dark-mode-red hover:su-text-digital-red"
            aria-expanded="true"
            aria-controls="menu"
          ...
          >
            ...
            <span
              className="su-text-12 su-block su-font-semibold"
              aria-hidden="true"
            >
              Close
            </span>
