    ...
    (title || story) && (
      ...
      <div className="report-header__story su-z-40 su-hidden md:su-flex su-flex-grow su-items-end">
        {title && (
          ...
          // md:su-pb-[14px] md:su-mb-[6.05px] lg:su-mb-[2.25px] lg:su-pb-[8.75px]
          <h1 className="su-m-0 su-text-14 lg:su-text-16 md:su-leading-[16.72px] su-my-auto su-font-bold su-flex-grow su-opacity-0 su-max-h-70 md:su-pb-[6.05px] lg:su-pb-0 lg:su-max-h-[7.9rem] su-text-ellipsis su-overflow-hidden">
            {decode(title)}
          </h1>
        )}
