...
const generateItems = (items, currentPage) => {
  const sharedClasses =
    "su-block su-pt-[13px] su-pb-[9px] su-border-b-4 su-no-underline su-text-black dark:su-text-white dark:hover:su-text-dark-mode-red dark:hover:su-border-dark-mode-red su-transition su-ease-in-out hover:su-border-digital-red hover:su-text-digital-red su-text-[16px] lg:su-text-[18px] su-leading-[21.5px]";
