...
export default function SingleCtaBlock({
  ...
  return (
    <div className="su-cc">
      <div className="su-flex su-flex-col-reverse xl:su-flex-row-reverse su-items-center su-justify-center su-gap-34 xl:su-gap-60 su-rounded-[8px] su-rs-py-8 su-rs-px-4 su-break-words su-transition-shadow su-border dark:su-border-2 su-border-black-30/30 dark:su-border-black su-shadow dark:su-shadow-black/80 su-bg-white dark:su-bg-black-true su-text-black dark:su-text-white">
        <div>
