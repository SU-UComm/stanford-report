...
// components/in-brief/server.jsx
var server_exports = {};
...
// components/in-brief/Component.jsx
...
// components/in-brief/Component.jsx
function InBrief({ points }) {
  const hasPoints = points.length > 0;
  return hasPoints ? /* @__PURE__ */ import_react4.default.createElement(Container, { width: "narrow" }, /* @__PURE__ */ import_react4.default.createElement(
    "div",
    {
      "data-test": "in-brief",
      className: "su-border-b su-border-black-20"
    },
    /* @__PURE__ */ import_react4.default.createElement("div", { className: "su-relative su-overflow-hidden" }, /* @__PURE__ */ import_react4.default.createElement("h2", { className: "su-font-serif su-font-black su-inline su-bg-white dark:su-bg-black-true !su-text-23 su-pr-10 su-m-0" }, "In brief"), /* @__PURE__ */ import_react4.default.createElement("span", { className: "su-w-full su-bg-black-20 su-h-px su-absolute su-bottom-4" })),
    /* @__PURE__ */ import_react4.default.createElement("div", { className: "su-wysiwyg-content" }, /* @__PURE__ */ import_react4.default.createElement("ul", { className: "su-basefont-19 su-flex su-flex-col su-mb-0 su-gap-18 su-pt-34 su-pb-27 [&>li]:su-m-0" }, points.map((item) => {
      return /* @__PURE__ */ import_react4.default.createElement(
        XssSafeContent_default,
        {
          elementType: "li",
          key: import_object_hash.default.MD5(item),
          className: [
...
var server_default = async (args) => {
  return renderComponent({ Component: InBrief, componentName: "in-brief", args });
};
