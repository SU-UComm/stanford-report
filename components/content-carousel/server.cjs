  ...
  "node_modules/react-dom/cjs/react-dom-server-legacy.node.development.js"(exports2) {
    ...
    if (process.env.NODE_ENV !== "production") {
      (function() {
        ...
        function renderToString2(children2, options) {
...
// components/content-carousel/server.jsx
var server_exports = {};
...
function renderLoop(swiper, slides, swiperParams) {
  const modifiedSlides = slides.map((child, index2) => {
    return /* @__PURE__ */ import_react4.default.cloneElement(child, {
      swiper,
  ...
  if (swiperParams.loopFillGroupWithBlank) {
    ...
    if (blankSlidesNum !== swiperParams.slidesPerGroup) {
      for (let i = 0; i < blankSlidesNum; i += 1) {
        const blankSlide = /* @__PURE__ */ import_react4.default.createElement("div", {
...
function processChildren(c) {
  const slides = [];
  import_react5.default.Children.toArray(c).forEach((child) => {
...
var SwiperSlideContext = /* @__PURE__ */ (0, import_react8.createContext)(null);
var SwiperContext = /* @__PURE__ */ (0, import_react8.createContext)(null);
...
var Swiper2 = /* @__PURE__ */ (0, import_react9.forwardRef)(function(_temp, externalElRef) {
  let {
    className,
    tag: Tag = "div",
  ...
  const [containerClasses, setContainerClasses] = (0, import_react9.useState)("swiper");
  const [virtualData, setVirtualData] = (0, import_react9.useState)(null);
  const [breakpointChanged, setBreakpointChanged] = (0, import_react9.useState)(false);
  const initializedRef = (0, import_react9.useRef)(false);
  const swiperElRef = (0, import_react9.useRef)(null);
  const swiperRef = (0, import_react9.useRef)(null);
  const oldPassedParamsRef = (0, import_react9.useRef)(null);
  const oldSlides = (0, import_react9.useRef)(null);
  const nextElRef = (0, import_react9.useRef)(null);
  const prevElRef = (0, import_react9.useRef)(null);
  const paginationElRef = (0, import_react9.useRef)(null);
  const scrollbarElRef = (0, import_react9.useRef)(null);
  const {
    params: swiperParams,
    passedParams,
    rest: restProps,
  ...
  function renderSlides() {
    ...
    if (!swiperParams.loop || swiperRef.current && swiperRef.current.destroyed) {
      return slides.map((child) => {
        return /* @__PURE__ */ import_react9.default.cloneElement(child, {
          swiper: swiperRef.current
        });
      });
    }
  ...
  }, restProps), /* @__PURE__ */ import_react9.default.createElement(SwiperContext.Provider, {
    value: swiperRef.current
  }, slots["container-start"], /* @__PURE__ */ import_react9.default.createElement(WrapperTag, {
    className: "swiper-wrapper"
  }, slots["wrapper-start"], renderSlides(), slots["wrapper-end"]), needsNavigation(swiperParams) && /* @__PURE__ */ import_react9.default.createElement(import_react9.default.Fragment, null, /* @__PURE__ */ import_react9.default.createElement("div", {
    ref: prevElRef,
    className: "swiper-button-prev"
  }), /* @__PURE__ */ import_react9.default.createElement("div", {
    ref: nextElRef,
    className: "swiper-button-next"
  })), needsScrollbar(swiperParams) && /* @__PURE__ */ import_react9.default.createElement("div", {
    ref: scrollbarElRef,
    className: "swiper-scrollbar"
  }), needsPagination(swiperParams) && /* @__PURE__ */ import_react9.default.createElement("div", {
    ref: paginationElRef,
...
var SwiperSlide = /* @__PURE__ */ (0, import_react10.forwardRef)(function(_temp, externalRef) {
  let {
    tag: Tag = "div",
    children: children2,
    className = "",
  ...
  const slideElRef = (0, import_react10.useRef)(null);
  const [slideClasses, setSlideClasses] = (0, import_react10.useState)("swiper-slide");
  ...
  return /* @__PURE__ */ import_react10.default.createElement(Tag, _extends2({
    ref: slideElRef,
    className: uniqueClasses(`${slideClasses}${className ? ` ${className}` : ""}`),
    "data-swiper-slide-index": virtualIndex
  }, rest), /* @__PURE__ */ import_react10.default.createElement(SwiperSlideContext.Provider, {
    value: slideData
  }, zoom ? /* @__PURE__ */ import_react10.default.createElement("div", {
...
function Carousel({
  ...
  const swiperRef = (0, import_react12.useRef)();
  const [sliderInit, setSliderInit] = (0, import_react12.useState)(false);
  const hasSlides = slides.length > 0;
  const [useFocus, setUseFocus] = (0, import_react12.useState)(false);
  ...
  return hasSlides ? /* @__PURE__ */ import_react12.default.createElement("div", { className: `component-slider ${isDark ? "su-slider-dark" : ""}` }, /* @__PURE__ */ import_react12.default.createElement(
    Swiper2,
    {
      loopAdditionalSlides: 0,
      slidesPerGroup: 1,
      pagination: {
        ...
        renderBullet: (index2, className) => {
          return `<button ${index2 === 0 ? 'aria-current="true"' : ""} class="${className}"><span class="sr-only">Slide ${index2 + 1}</span></button>`;
        }
      },
      onSlideChange: (swiper) => {
        var _a;
        const oldSlide = (_a = swiper.$wrapperEl) == null ? void 0 : _a[0].querySelector(
          ".swiper-slide-active"
        );
        if (oldSlide) {
        ...
        if (sliderInit) {
          setTimeout(() => {
            var _a2;
            const slide = (_a2 = swiper.$wrapperEl) == null ? void 0 : _a2[0].querySelector(
              ".swiper-slide-active"
            );
            const slideTarget = slide.querySelector("h2 a, h3 a, button") ? slide.querySelector("h2 a, h3 a, button") : (() => {
    ...
    slides.map((slide) => /* @__PURE__ */ import_react12.default.createElement(
      SwiperSlide,
      {
        key: import_object_hash.default.MD5(
          JSON.stringify(slide) + import_object_hash.default.MD5(JSON.stringify(slide))
        )
      },
      slide
    ))
  ), slides.length > 1 && /* @__PURE__ */ import_react12.default.createElement("div", { className: "component-slider-controls su-flex su-mt-45 lg:su-mt-48 su-items-center su-content-center" }, /* @__PURE__ */ import_react12.default.createElement(
    "div",
    {
    ...
    "button",
    {
      ...
      onClick: () => {
        var _a;
        return (_a = swiperRef.current) == null ? void 0 : _a.slidePrev();
      }
    },
    /* @__PURE__ */ import_react12.default.createElement("span", { className: "sr-only" }, "Previous"),
    /* @__PURE__ */ import_react12.default.createElement(
      "span",
      {
        "aria-hidden": "true",
      ...
      /* @__PURE__ */ import_react12.default.createElement(ChevronRight, null)
    )
  ), /* @__PURE__ */ import_react12.default.createElement(
    "button",
    {
    ...
    /* @__PURE__ */ import_react12.default.createElement("span", { className: "sr-only" }, "Next"),
    /* @__PURE__ */ import_react12.default.createElement(
      "span",
      {
        "aria-hidden": "true",
