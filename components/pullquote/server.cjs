...
// components/pullquote/server.jsx
var server_exports = {};
...
// components/pullquote/Component.jsx
var import_react12 = __toESM(require_react(), 1);

// packages/quotes/PullQuote.jsx
...
// packages/quotes/Avatar.jsx
var import_react3 = __toESM(require_react(), 1);
function Avatar({ image, avatarSize = "small", alt = "" }) {
  const avatarWrapperClasses = /* @__PURE__ */ new Map();
  ...
  const avatarImageClasses = /* @__PURE__ */ new Map();
  ...
  return image ? /* @__PURE__ */ import_react3.default.createElement(
    "div",
    {
...
function PullQuote({
  ...
  const Tag = tag;
  return quote ? /* @__PURE__ */ import_react4.default.createElement(
    Tag,
    {
      className: [
    ...
    /* @__PURE__ */ import_react4.default.createElement(Avatar, { image: avatar, avatarSize, alt: imageAlt }),
    /* @__PURE__ */ import_react4.default.createElement(
      ...
      name && /* @__PURE__ */ import_react4.default.createElement("cite", { className: "su-mt-15 md:su-mt-26 lg:su-mt-29 su-font-sans su-text-21 su-leading-[25.2px] su-flex su-flex-col" }, /* @__PURE__ */ import_react4.default.createElement("span", { className: "su-font-bold su-block su-leading-[25.2px]" }, name), title && /* @__PURE__ */ import_react4.default.createElement("span", { className: "su-block su-leading-[25.2px]" }, title))
    )
  ) : "";
}
...
function Container({
  ...
  return hasChildren ? /* @__PURE__ */ import_react5.default.createElement(
    "div",
    {
...
// components/pullquote/Component.jsx
function PullQuoteStory({ displayConfiguration, imageUrl }) {
  const { quote, name, title, width } = displayConfiguration;
  return /* @__PURE__ */ import_react12.default.createElement(Container, { width }, /* @__PURE__ */ import_react12.default.createElement(PullQuote, { quote, name, title, avatar: imageUrl }));
}
...
var server_default = async (args, info) => {
  ...
  let imageUrl = null;
  if (!["", "undefined", void 0, null].includes(matrixAsset)) {
