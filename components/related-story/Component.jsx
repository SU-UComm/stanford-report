...
import { BullseyePointer } from "../../packages/SVG-library/SVG";
...
export default function RelatedStory({ data }) {
  ...
  return (
    <section className="su-px-[20px] su-py-[32px] story__related-story su-col-span-full su-max-w-[636px] sm:su-col-span-10 sm:su-col-start-2 lg:su-col-span-6 lg:su-col-start-4 su-mx-auto !su-my-[90px]">
      <h3 className="su-flex su-items-center su-text-[20px] md:su-text-[28px] su-gap-[9px] su-mb-[30px] lg:su-mb-[36px] lg:su-mb-[38px]">
        <BullseyePointer />
        Related story
      </h3>

      <a className="su-text-black su-no-underline" href={liveUrl}>
        <div className="su-flex su-gap-[20px] sm:su-gap-[40px]">
          <img
          ...
          <div className="">
            ...
            <XssSafeContent
              className="su-text-[16px] sm:su-text-[18px] su-leading-[125%] !su-m-0 su-font-normal"
              content={description}
            />
          </div>
        </div>
