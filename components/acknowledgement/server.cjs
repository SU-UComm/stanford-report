...
// components/acknowledgement/server.jsx
var server_exports = {};
...
// components/acknowledgement/Component.jsx
function Acknowledgement({ title, content }) {
  const hasContent = !!(content !== "" && content !== void 0);
  return hasContent ? /* @__PURE__ */ import_react4.default.createElement(Container, { width: "narrow" }, /* @__PURE__ */ import_react4.default.createElement(
    "hr",
    {
      "aria-hidden": "true",
  ...
  ), title && /* @__PURE__ */ import_react4.default.createElement("h2", { className: "sr-only" }, title), /* @__PURE__ */ import_react4.default.createElement(
...
var server_default = async (args) => {
  return renderComponent({ Component: Acknowledgement, componentName: "acknowledgement", args });
};
