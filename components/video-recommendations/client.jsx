...
(async function () {
  const element = document.querySelector(
    `[data-hydration-component="video-recommendations"]`
  );
  if (!element) return;
  ...
  if (props.data === undefined) {
    ...
    if (props.search) {
      ...
      }&meta_taxonomyContentTypeText=Video&sort=date&meta_taxonomyAudienceText=${audience}&num_ranks=6&meta_id_not=${
  ...
  hydrateComponent({ Component, componentName: "video-recommendations" });
})();
