...
// components/multicolumn-image/server.jsx
var server_exports = {};
...
// components/multicolumn-image/Component.jsx
...
// components/multicolumn-image/Component.jsx
function MulticolumnImage({ data, imageCaptions }) {
  const numberOfCaptions = imageCaptions.filter(Boolean).length;
  const images = data.map((image, i) => /* @__PURE__ */ import_react3.default.createElement(
    Image,
    {
      src: image.url,
      caption: imageCaptions[i],
      numberOfCaptions,
      key: import_object_hash.default.MD5(image)
    }
  ));
  return /* @__PURE__ */ import_react3.default.createElement(Container, { width: "wide" }, /* @__PURE__ */ import_react3.default.createElement("section", { className: "su-flex su-flex-col su-items-center su-gap-8 md:su-gap-9" }, /* @__PURE__ */ import_react3.default.createElement("div", { className: "su-flex su-gap-20 su-items-center lg:su-gap-48" }, images), numberOfCaptions === 1 && /* @__PURE__ */ import_react3.default.createElement("p", { className: "su-text-14 su-text-black-70 dark:su-text-black-30 su-font-normal su-max-w-[63.3rem] su-leading-[119.415%] su-text-center md:su-text-16 su-mb-0" }, imageCaptions.filter(Boolean)[0])));
}
function Image({ src, caption, numberOfCaptions }) {
  return /* @__PURE__ */ import_react3.default.createElement("div", { className: "su-relative su-flex su-flex-col su-gap-8 su-flex-1" }, /* @__PURE__ */ import_react3.default.createElement("img", { src, className: "su-object-cover", alt: "" }), caption && numberOfCaptions > 1 && /* @__PURE__ */ import_react3.default.createElement("p", { className: "su-text-14 su-text-black-70 dark:su-text-black-30 su-font-normal su-leading-[119.415%] su-text-center su-m-0 md:su-text-16" }, caption));
}
