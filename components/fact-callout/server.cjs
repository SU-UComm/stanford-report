...
// components/fact-callout/server.jsx
var server_exports = {};
...
function PieChart({ variant = DEFAULT_VARIANT }) {
...
function BarGraph({ variant = DEFAULT_VARIANT2 }) {
  const variantsMap = /* @__PURE__ */ new Map();
  variantsMap.set(
    "light",
...
function FactCallout({ displayConfiguration }) {
  ...
  svgMap.set("pie chart", {
    light: /* @__PURE__ */ import_react74.default.createElement(PieChart, { variant: "light" }),
    dark: /* @__PURE__ */ import_react74.default.createElement(PieChart, { variant: "dark" })
  });
  svgMap.set("bar graph", {
    light: /* @__PURE__ */ import_react74.default.createElement(BarGraph, { variant: "light" }),
    dark: /* @__PURE__ */ import_react74.default.createElement(BarGraph, { variant: "dark" })
  });
  ...
  return /* @__PURE__ */ import_react74.default.createElement("div", { className: `decoration-${indicatorPosition}` }, /* @__PURE__ */ import_react74.default.createElement(Container, { width }, /* @__PURE__ */ import_react74.default.createElement("section", { className: "fact-wrapper su-col-span-full su-w-full su-relative su-h-auto su-p-3 su-bg-gradient-light-red-h-reverse" }, /* @__PURE__ */ import_react74.default.createElement(
    "div",
    {
      className: `${indicator} su-absolute su-left-1/2 su-right-1/2 su-flex su-items-center su-justify-start su-w-24 su-h-90`
    },
    /* @__PURE__ */ import_react74.default.createElement("div", { className: "su-w-3 su-h-72 lg:su-h-60 su-bg-gradient-light-red-h-reverse" }),
    /* @__PURE__ */ import_react74.default.createElement("div", { className: "su-size-24 su-rounded-full su-bg-gradient-light-red-h-reverse su-flex su-items-center su-justify-center" }, /* @__PURE__ */ import_react74.default.createElement("div", { className: "su-size-18 su-rounded-full su-bg-white dark:su-bg-black-true" }))
  ), /* @__PURE__ */ import_react74.default.createElement(
    "div",
    {
      className: `su-px-38 ${width === "Wide" ? "md:su-px-[12.1rem]" : ""} su-py-38 md:su-py-61 su-size-full su-bg-white dark:su-bg-black-true su-flex su-flex-col su-items-center su-justify-center su-gap-10 lg:su-flex-row lg:su-gap-38`
    },
    svgMap.get(icon) && "light" in svgMap.get(icon) && "dark" in svgMap.get(icon) && /* @__PURE__ */ import_react74.default.createElement(import_react74.default.Fragment, null, /* @__PURE__ */ import_react74.default.createElement("span", { "data-test": "icon", className: "dark:su-hidden" }, svgMap.get(icon).light), /* @__PURE__ */ import_react74.default.createElement("span", { "data-test": "icon", className: "su-hidden dark:su-block" }, svgMap.get(icon).dark)),
    /* @__PURE__ */ import_react74.default.createElement("p", { className: "su-font-serif su-m-0" }, factText)
  ))));
}

// components/fact-callout/server.jsx
var server_default = async (args) => {
  return renderComponent({ Component: FactCallout, componentName: "fact-callout", args });
};
