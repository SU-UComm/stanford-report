  ...
  return (
    <div className={`decoration-${indicatorPosition}`}>
      <Container width={width}>
        <section className="fact-wrapper su-col-span-full su-w-full su-relative su-h-auto su-p-[3px] su-bg-gradient">
          <div
          ...
          <div
            ...
            } su-py-[38px] md:su-py-[61px] su-size-full su-bg-white dark:su-bg-black su-flex su-flex-col su-items-center su-justify-center su-gap-[10px] lg:su-flex-row lg:su-gap-[38px] su-items-center`}
          >
