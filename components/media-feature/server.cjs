    ...
    if (process.env.NODE_ENV !== "production") {
      (function() {
        ...
        function flattenOptionChildren(children) {
          var content = "";
          React78.Children.forEach(children, function(child) {
            if (child == null) {
              return;
            }
            content += child;
...
var require_react_fontawesome = __commonJS({
  "node_modules/@fortawesome/react-fontawesome/index.js"(exports2, module2) {
    ...
    })(exports2, function(exports3, fontawesomeSvgCore, PropTypes, React78) {
      "use strict";
      function _interopDefaultLegacy(e) {
        return e && typeof e === "object" && "default" in e ? e : { "default": e };
      }
      var PropTypes__default = /* @__PURE__ */ _interopDefaultLegacy(PropTypes);
      var React__default = /* @__PURE__ */ _interopDefaultLegacy(React78);
...
// components/media-feature/server.jsx
var server_exports = {};
...
// components/media-feature/Component.jsx
...
function Container({
  ...
  return hasChildren ? /* @__PURE__ */ import_react2.default.createElement(
    "div",
    {
...
var ARROW_SIZE = "small";
function ExternalArrow({ size = ARROW_SIZE }) {
...
function BullseyePointer2({ variant = DEFAULT_VARIANT7 }) {
  const variantsMap = /* @__PURE__ */ new Map();
  variantsMap.set(
    "light",
...
var DEFAULT_VARIANT8 = "light";
function TrendingUp({ variant = DEFAULT_VARIANT8 }) {
  const variantsMap = /* @__PURE__ */ new Map();
  variantsMap.set(
    "light",
  ...
  return variantsMap.get(DEFAULT_VARIANT8);
}
...
function SidebarHeading({
  ...
  iconMap.set("bullseyePointer", {
    light: /* @__PURE__ */ import_react76.default.createElement(BullseyePointer2, { variant: "light" }),
    dark: /* @__PURE__ */ import_react76.default.createElement(BullseyePointer2, { variant: "dark" })
  });
...
function MediaFeature({
  ...
  return /* @__PURE__ */ import_react77.default.createElement(Container, { width: "full", paddingX: false }, /* @__PURE__ */ import_react77.default.createElement("section", { className: "su-py-45 su-px-20 su-flex su-justify-center su-relative md:su-py-72 md:su-px-50" }, /* @__PURE__ */ import_react77.default.createElement("div", { className: "su-group su-max-w-[1086px] su-flex su-flex-col su-items-center su-z-[2] su-relative su-p-38 before:su-content-[''] before:su-bg-foggy-light before:su-w-full before:su-h-full before:su-opacity-90 before:su-absolute before:su-z-[-1] before:su-top-0 before:su-left-0 md:su-flex-row md:su-gap-20 md:su-items-start lg:su-p-48 lg:su-gap-48" }, /* @__PURE__ */ import_react77.default.createElement(
    "div",
    {
      className: `${mediaType === "Podcast" && "su-w-[224px] md:su-w-[182px] lg:su-w-[292px]"} su-h-[224px] md:su-h-[182px] lg:su-h-[292px] su-relative su-shrink-0 ${mediaType === "Book" && "media-feature__thumb"}`
    },
  ...
  ), /* @__PURE__ */ import_react77.default.createElement("div", null, /* @__PURE__ */ import_react77.default.createElement("div", { className: "su-py-20 su-w-full md:su-pb-27 md:su-pt-0 *:dark:su-text-black" }, /* @__PURE__ */ import_react77.default.createElement(FeaturedHeading, { type: mediaType })), /* @__PURE__ */ import_react77.default.createElement("h3", { className: "su-text-[35px] su-font-bold su-leading-tight su-m-0 su-pb-8 md:su-pb-19 md:su-text-[40px] lg:su-text-[43px]" }, /* @__PURE__ */ import_react77.default.createElement(
    "a",
    {
      href: linkUrl,
    ...
    title,
    /* @__PURE__ */ import_react77.default.createElement("span", { className: "su-hidden lg:su-inline-block su-relative su-top-12 [&>*]:su-stroke-digital-red dark:[&>*]:su-stroke-dark-mode-red su-transition group-hocus:su--translate-y-01em group-hocus:su-translate-x-01em [&>svg]:su-translate-y-1" }, /* @__PURE__ */ import_react77.default.createElement(ExternalArrow, { size: "large" }))
  )), /* @__PURE__ */ import_react77.default.createElement("div", { className: "su-w-full su-flex su-gap-[0.6rem] su-text-18 su-text-black-70 su-font-semibold su-items-center su-pb-15 su-leading-snug md:su-pb-19 md:su-text-16" }, /* @__PURE__ */ import_react77.default.createElement(MediaType, { type: mediaType })), /* @__PURE__ */ import_react77.default.createElement("p", { className: "su-text-18 su-w-full su-m-0 su-leading-[125%] su-text-black su-font-normal md:su-text-19 lg:su-text-21" }, teaserText))), /* @__PURE__ */ import_react77.default.createElement(
    "img",
    {
      src: bgImageData.url,
...
function MediaType({ type }) {
  const iconMap = /* @__PURE__ */ new Map();
  iconMap.set("Podcast", /* @__PURE__ */ import_react77.default.createElement(BullseyePointer, { variant: "outline" }));
  iconMap.set("Book", /* @__PURE__ */ import_react77.default.createElement(BookOpenCover, { className: "su-w-[1.2em]", "aria-hidden": true }));
  return /* @__PURE__ */ import_react77.default.createElement(import_react77.default.Fragment, null, /* @__PURE__ */ import_react77.default.createElement("span", { className: "*:su-size-20" }, iconMap.get(type)), type);
}
function FeaturedHeading({ type }) {
  switch (type) {
    case "Podcast":
      return /* @__PURE__ */ import_react77.default.createElement(SidebarHeading, { icon: "Featured audio", title: "Featured audio" });
    default:
      return /* @__PURE__ */ import_react77.default.createElement(SidebarHeading, { icon: "Featured reading", title: "Featured book" });
  }
}
