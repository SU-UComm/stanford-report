...
// components/campaign-cta/server.jsx
var server_exports = {};
...
// components/campaign-cta/Component.jsx
function CampaignCta({ displayConfiguration, data, linkData }) {
  const { title, description, linkText } = displayConfiguration;
  return /* @__PURE__ */ import_react4.default.createElement(Container, { width: "full", paddingX: false }, /* @__PURE__ */ import_react4.default.createElement("section", { className: "su-container-inner su-relative su-flex su-items-center su-justify-center su-flex-col" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "su-component-campaigncta-wrap su-pt-126 su-pb-108 su-relative su-z-[2] su-text-white su-p-20 md:su-px-50 su-flex su-flex-col md:su-flex-row" }, /* @__PURE__ */ import_react4.default.createElement("div", { className: "su-component-campaigncta-content su-relative md:su-border-r-black-30 md:su-border-r md:su-mr-25 su-w-full md:su-max-w-[65.5rem] md:su-pr-25" }, /* @__PURE__ */ import_react4.default.createElement("h2", { className: "su-font-serif su-text-[5.5rem] su-leading-none md:su-text-[7.2rem] su-m-0 su-font-bold" }, title), /* @__PURE__ */ import_react4.default.createElement(
  ...
  )), linkData && linkData.url && /* @__PURE__ */ import_react4.default.createElement(
    "a",
    {
      href: linkData.url,
  ...
  ), /* @__PURE__ */ import_react4.default.createElement("div", { className: "su-campaign-cta-gradient su-z-[1]" })));
}
