        ...
        <div className="su-pt-[126px] su-pb-[108px] su-relative su-z-[2] su-text-white su-p-[20px] su-flex su-flex-col lg:su-flex-row">
          <div className="su-relative lg:su-border-r-black-30 lg:su-border-r lg:su-border-r-solid lg:su-mr-[25px] su-max-w-[655px] lg:su-pr-[25px]">
            ...
            <XssSafeContent
              ...
              elementType="div"
              className={[
                "su-mt-[34px] su-font-serif su-text-[20px] md:su-text-[24px] su-mb-0 lg:su-mb-[59px] su-text-semibold md:su-mt-[61px]",
          ...
          {linkData && linkData.url && (
            <a
              href={linkData.url}
              className="su-text-[18px] su-mt-[50px] su-leading-[120%] su-inline-block su-px-[30px] su-pt-[10px] su-pb-[12px] su-bg-digital-red su-mr-auto su-text-white su-no-underline hover:su-bg-black su-transition md:su-px-[35px] md:su-pt-[14px] md:su-pb-[16px] md:su-text-[24px] md:su-leading-[119.415%] lg:su-mt-auto su-shrink-0"
            >
              {linkText}
            </a>
          )}
