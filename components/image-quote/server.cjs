...
// components/image-quote/server.jsx
var server_exports = {};
...
// components/image-quote/Component.jsx
var import_react3 = __toESM(require_react(), 1);
var import_cnbuilder2 = __toESM(require_cjs(), 1);
...
// components/image-quote/Component.jsx
function ImageQuote({ displayConfiguration, data }) {
  const { imageCaption, imageCredit, quote, name, title } = displayConfiguration;
  const imageOrientation = data.attributes.height > data.attributes.width ? "portrait" : "landscape";
  const imageWidthMaps = /* @__PURE__ */ new Map();
  ...
  const widthClasses2 = imageWidthMaps.get(imageOrientation);
  const captionCredit = imageCaption && imageCredit ? `${imageCaption} | ${imageCredit}` : imageCaption || imageCredit;
  return /* @__PURE__ */ import_react3.default.createElement(Container, { width: "large" }, /* @__PURE__ */ import_react3.default.createElement(
    "section",
    {
      className: (0, import_cnbuilder2.cnb)(
        "story__quote su-relative",
        "su-flex su-flex-wrap lg:su-flex-nowrap lg:su-items-start",
        widthClasses2.line,
        "before:su-absolute before:su-h-4 before:su-z-0 before:su-right-0 before:su-top-45 lg:before:su-top-72 su-bg-gradient-before-reverse",
        "after:su-absolute after:su-w-4 after:su-z-[-10] after:su-h-[calc(100%-4.5rem)] after:su-right-0 after:su-top-45 lg:after:su-top-72 su-bg-gradient-after-reverse",
        imageOrientation === "landscape" ? "md:before:su-top-[20%] md:after:su-top-[20%] md:after:su-h-[80%] lg:after:su-h-[calc(100%-16rem)]" : "md:before:su-top-[30%] md:after:su-top-[30%] md:after:su-h-[70%] lg:after:su-hidden"
      )
    },
    /* @__PURE__ */ import_react3.default.createElement(
      "figure",
      {
        className: (0, import_cnbuilder2.cnb)("su-flex su-flex-col su-gap-8", widthClasses2.image)
      },
      /* @__PURE__ */ import_react3.default.createElement(
        "img",
        {
      ...
      /* @__PURE__ */ import_react3.default.createElement("figcaption", { className: "dark:su-text-white su-text-14 su-font-normal su-mt-8 md:su-text-16" }, captionCredit)
    ),
    /* @__PURE__ */ import_react3.default.createElement(
      "figure",
      {
        className: (0, import_cnbuilder2.cnb)(
          ...
          widthClasses2.quote,
          imageOrientation === "portrait" && "after:su-hidden lg:after:su-block su-bg-gradient-after-reverse after:su-absolute after:su-w-4 after:su-z-[-10] after:su-h-[calc(100%-8.8rem)] after:su-right-0 after:su-top-0"
        )
      },
      /* @__PURE__ */ import_react3.default.createElement(
        "blockquote",
      ...
      /* @__PURE__ */ import_react3.default.createElement("figcaption", { className: "su-relative su-text-black su-basefont-21 su-mt-0 su-flex su-flex-col dark:su-text-white su-text-16 md:su-text-21 su-font-normal lg:su-flex su-gap-5 md:su-gap-6" }, /* @__PURE__ */ import_react3.default.createElement("strong", null, name), " ", /* @__PURE__ */ import_react3.default.createElement("span", null, title))
    )
  ));
}
