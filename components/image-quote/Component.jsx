    ...
    <Container width="large">
      <section
        className={[
          ...
          widthClasses.line,
          "after:su-absolute after:su-w-4 after:su-z-[-10] after:su-top-[45px] lg:after:su-top-72 after:su-right-0 su-bg-gradient-after-reverse after:su-h-[calc(100%-45px)] md:after:su-h-[calc(100%-30%)] lg:after:su-h-[calc(100%-72px)] lg:after:su-hidden",
        ].join(" ")}
      >
        <figure
