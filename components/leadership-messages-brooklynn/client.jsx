...
(async function () {
  const element = document.querySelector(
    `[data-hydration-component="leadership-messages-brooklynn"]`
  );
  if (!element) return;
  ...
  if (props.data === undefined) {
    ...
    if (props.search) {
      ...
      }&meta_taxonomyAudienceText=${audience}&num_ranks=3&meta_id_not=${props.search.currentPage}`;
    }
...
// Check if we have a URL to fetch data from
  ...
  hydrateComponent({ Component, componentName: "leadership-messages-brooklynn" });
})();
