...
export default function MetadataFields({ data }) {
  ...
  switch (type) {
    case "Basic":
      return <BasicMetadata data={data} />;
    default:
  }
  ...
  //       <div
  //         className={
  //           type === "Basic" ? "su-fields-basic" : "su-fields-featured"
  //         }
  //       >
  ...
  //           <div className="">
  //             <h3 className="">
  //               Videographer{videographers.length > 1 && "s"}
  //             </h3>
  ...
  //           <div className="">
  //             <h3 className="">
  //               Media contact{videographers.length > 1 && "s"}
  //             </h3>
  //             {media.map((item) => (
  //               <div className="" key={item.asset_assetid}>
  //                 {item.asset_name}
