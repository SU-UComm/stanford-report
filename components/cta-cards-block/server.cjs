...
// components/cta-cards-block/server.jsx
var server_exports = {};
...
// components/cta-cards-block/Component.jsx
var import_react6 = __toESM(require_react(), 1);

// packages/card/CtaCard.jsx
...
function ExternalArrowUnstyled(props) {
...
function CtaCard({
  ...
  const isRealExternalLink = !!externalUrl && !(externalUrl == null ? void 0 : externalUrl.includes("news.stanford.edu"));
  return /* @__PURE__ */ import_react5.default.createElement(
    "article",
    {
      ...
      className: (0, import_cnbuilder.cnb)(
        ...
        internalUrl || externalUrl ? "hover:su-shadow-md focus-within:su-shadow-md" : "",
    ...
    /* @__PURE__ */ import_react5.default.createElement("h3", { className: "su-type-5 md:su-type-4 2xl:su-type-3 su-mb-0 su-font-sans su-text-black dark:su-text-white" }, hasLink ? (
      ...
      /* @__PURE__ */ import_react5.default.createElement(
        "a",
        {
          ...
          rel: isRealExternalLink ? "noopener nofollow" : void 0,
        ...
        eyebrow && /* @__PURE__ */ import_react5.default.createElement("span", { className: "su-sr-only" }, `${eyebrow}:`),
        title,
        isRealExternalLink && /* @__PURE__ */ import_react5.default.createElement("span", { className: "su-sr-only" }, "(link is external)")
      )
    ) : /* @__PURE__ */ import_react5.default.createElement(import_react5.default.Fragment, null, eyebrow && /* @__PURE__ */ import_react5.default.createElement("span", { className: "su-sr-only" }, `${eyebrow}:`), title)),
    !!description && /* @__PURE__ */ import_react5.default.createElement("div", { className: "su-grow" }, /* @__PURE__ */ import_react5.default.createElement(
    ...
    hasLink && /* @__PURE__ */ import_react5.default.createElement("div", { className: "su-mt-auto" }, /* @__PURE__ */ import_react5.default.createElement(
      "div",
      {
        className: (0, import_cnbuilder.cnb)(
          ...
          isRealExternalLink ? "group-hocus-within:su-translate-x-02em group-hocus-within:su--translate-y-02em" : "group-hocus-within:su-translate-x-03em"
        )
      },
      isRealExternalLink ? /* @__PURE__ */ import_react5.default.createElement(
...
// components/cta-cards-block/Component.jsx
function CtaCardsBlock({ cardsArray }) {
  return /* @__PURE__ */ import_react6.default.createElement("div", { className: "su-relative su-cc su-flex su-grid-gap su-flex-col 2xl:su-flex-row" }, cardsArray.map((card) => {
    const { eyebrow, title, description, linkDetails, internalLinkUrl } = card;
    return /* @__PURE__ */ import_react6.default.createElement(
      CtaCard,
      {
        ...
        externalUrl: linkDetails == null ? void 0 : linkDetails.externalUrl,
        isNewWindow: linkDetails == null ? void 0 : linkDetails.isNewWindow
      }
    );
  }));
}
...
var server_default = async (args, info) => {
  ...
  const cardsArray = await Promise.all(
    cards.map(async (card) => {
      ...
      let linkUrl = null;
      if (linkDetails == null ? void 0 : linkDetails.internalUrl) {
        linkUrl = await basicAssetUri(ctx, linkDetails.internalUrl);
      }
      const internalLinkUrl = linkUrl == null ? void 0 : linkUrl.url;
      return {
        eyebrow,
        title,
        description,
