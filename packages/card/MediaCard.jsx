...
export default function MediaCard({
  ...
  return title ? (
    ...
    >
      {imageUrl && (
        <div className="su-relative su-px-[20px] md:su-px-0 su-h-[342px] lg:su-h-[373px] lg:su-h-[572px] su-min-w-[249px] md:su-min-w-[249px] lg:su-min-w-[382px] su-flex su-items-center su-justify-center">
          <img
