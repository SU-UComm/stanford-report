  ...
  return (
    <Container>
      <header className="basic-story__header su-relative su-w-full su-max-w-[1512px] su-mx-auto su-grid su-grid-cols-6 sm:su-grid-cols-12">
        ...
        <div className="su-w-2 su-h-3/5 su-absolute su-left-20 sm:su-left-[10%] su-top-80 lg:su-top-[240px] su-bg-gradient su-z-0" />
        <div className="su-w-[10%] sm:su-w-1/4 su-h-2 su-absolute su-left-20 sm:su-left-[10%] su-top-80 lg:su-top-[239px] su-bg-gradient su-z-0" />
        <div className="su-w-2 su-h-3/5 su-absolute su-right-20 sm:su-right-[10%] su-bottom-0 su-bg-gradient su-z-0" />
        ...
        <figure className="basic-story__header-image su-flex su-flex-col su-gap-6 su-col-span-full su-relative su-translate-y-[-110px] sm:su-translate-y-[-130px] lg:su-translate-y-[-200px] xl:su-translate-y-[-220px] su-z-0 md:su-gap-18 lg:su-gap-15">
          ...
          >
            <img
              ...
              className="su-relative su-w-full su-h-300 sm:su-h-500 lg:su-h-[764px] su-object-cover su-object-center"
            />
        ...
        <p className="su-col-span-5 su-col-start-2 sm:su-col-span-6 sm:su-col-start-3 su-pr-40 sm:su-pr-20 su-h-min su-mx-auto su-font-semibold su-text-left font-serif-4 su-text-20 su-leading-[23.88px] md:su-text-23 md:su-leading-[28.75px] lg:su-text-[32px] lg:su-leading-[41.68px]">
          {summary}
        </p>

        <span className="su-col-span-full su-pr-40 su-col-start-2 sm:su-col-span-4 sm:su-col-start-7 su-mt-[71px] su-flex su-items-start su-flex-row md:su-flex-row su-justify-end su-text-16 su-leading-[19.1px] md:su-text-23 md:su-leading-[28.75px] md:su-basefont-23">
