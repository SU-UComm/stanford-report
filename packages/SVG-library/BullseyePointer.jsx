 ...
 * @returns {JSX.Element}
 */
export default function BullseyePointer({ variant = DEFAULT_VARIANT }) {
  ...
  variantsMap.set(
    ...
    >
      ...
      <defs>
        ...
        >
          <stop className="su-stop-red" />
          <stop offset="1" className="su-stop-plum" />
        </linearGradient>
    ...
    >
      ...
      <defs>
        <linearGradient
          ...
          gradientUnits="userSpaceOnUse"
        >
          <stop className="su-stop-teal" />
          <stop offset="1" className="su-stop-green" />
        </linearGradient>
        <clipPath id="clip0_2402_1235">
          <rect width="27" height="27" fill="white" />
        </clipPath>
